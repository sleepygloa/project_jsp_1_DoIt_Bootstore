...
<c:if test="${check == false}">
	...
	<script type="text/javascript">
			...
			{
				//alert("신고가 완료 되었습니다");
				window.location="/DoIt/d_resell/reReportPro.do?rbook_no=${rbook_no}&pageNum=${pageNum}&report_id=${report_id}&report_id2=${report_id2}&report_content=${report_content}";
			} else {
			    alert("취소 되었습니다.");
			    history.go(-1);
			}
